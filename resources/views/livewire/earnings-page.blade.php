<div class="halpha-w-full halpha-space-y-4">
  ...
  <div class="halpha-grid halpha-grid-cols-2 halpha-gap-3">
    <div class="halpha-card halpha-p-3 halpha-flex halpha-flex-col">
      ...
      <div class="halpha-text-lg halpha-font-bold halpha-text-white">{{ number_format((float)$totalEarned, 8) }}</div>
    </div>
    ...
    <div class="halpha-card halpha-p-3 halpha-flex halpha-flex-col">
      ...
      <div class="halpha-flex halpha-items-center halpha-justify-between">
        <div class="halpha-text-lg halpha-font-bold halpha-text-white">{{ number_format((float)$withdrawable, 8) }}</div>
        <button wire:click="claimAll" class="halpha-text-xs halpha-px-3 halpha-py-2 halpha-rounded halpha-bg-accent-2 halpha-text-white halpha-font-semibold"
  ...
  <div class="halpha-flex halpha-flex-col sm:halpha-flex-row halpha-gap-3 halpha-items-center">
    <div class="halpha-flex halpha-items-center halpha-gap-2 halpha-w-full sm:halpha-w-auto">
      ...
      <button wire:click="$set('search','')" class="halpha-ml-2 halpha-text-xs halpha-px-3 halpha-py-2 halpha-rounded halpha-border halpha-border-gray-700">Clear</button>
    </div>

    <div class="halpha-mt-2 sm:halpha-mt-0 halpha-ml-auto halpha-flex halpha-items-center halpha-gap-2">
      <select wire:model="filter" class="halpha-bg-gray-800 halpha-text-sm halpha-px-3 halpha-py-2 halpha-rounded">
