<div x-data class="halpha-w-full">
    <x-dashboard.halpha-table :columns="[
    ...
    ]" :rows="$rows" class="halpha-shadow-sm">
        @slot('actions')
        <div class="halpha-flex halpha-items-center halpha-gap-2">
            <a href="#" class="halpha-text-sm halpha-bg-accent halpha-py-1 halpha-px-2 halpha-rounded">New</a>
        </div>
        @endslot
