<div class="halpha-space-y-6">
    ...
    {{-- 🏁 PHASE HEADER --}}
    <div class="halpha-flex halpha-items-center halpha-justify-between halpha-bg-gradient-to-r halpha-from-blue-800/2 halpha-to-sky-200/5 halpha-opacity-90 halpha-border halpha-border-accent-3 halpha-rounded-xl halpha-p-3">
