...
@section('content')
    <div class="halpha-px-3 md:halpha-px-6 halpha-py-12 halpha-bg-[#070707] halpha-text-white halpha-min-h-screen">
        <div class="halpha-max-w-7xl halpha-mx-auto">
            <div class="halpha-flex halpha-flex-col md:halpha-flex-row halpha-items-center halpha-justify-between halpha-mb-6">
                <div>
