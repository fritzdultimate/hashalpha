...
@section('content')
    ...
    <nav class="halpha-mb-10 halpha-sticky halpha-top-0 halpha-bg-[rgba(6,8,12,0.6)] halpha-backdrop-blur halpha-py-3 halpha-z-40">
    ...
    <section id="mev" class="halpha-py-16 md:halpha-py-32">
        <div class="container-default w-container">
            <div class="inner-container _608px _100-tablet">
                ...
                <p class="!halpha-text-gray-400">We integrate MEV-boost relay services to increase proposer revenue while applying risk controls and revenue-sharing rules — designed to maximize yield without sacrificing decentralization.</p>
            </div>
            ...
            <div class="halpha-grid halpha-grid-cols-1 md:halpha-grid-cols-2 halpha-gap-6 halpha-mt-6">
                <div>
                    ...
                    <p class="halpha-text-sm halpha-text-gray-300">MEV (Maximal Extractable Value) is additional proposer revenue captured from transaction ordering and bundle execution. We use vetted relays and ethical MEV strategies.</p>

                    <h4 class="halpha-text-white halpha-font-semibold halpha-mt-4">Revenue Split</h4>
                    <p class="halpha-text-sm halpha-text-gray-300">Proposer revenue is split between the validators and the staking pool per plan. Typical split example: 70% to stakers / 30% operational & infra fee (example — update with your policy).</p>
                </div>
